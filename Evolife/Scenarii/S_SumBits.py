...
class Scenario(Default_Scenario):
	...
	def default_view(self):	return ['Genomes', 'Legend']
	...
	def legends(self):
		...
		"""
		return """Genome Window:\nEach horizontal line represents the genome of an individual.\n\nField window:\nIndividuals are displayed by they rank (x-axis) and their score (y-axis).
		"""
