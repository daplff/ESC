...
from Evolife.Ecology.Alliances import Friend
...
class EvolifeIndividual(Individual, Genome, Phenome, Friend):
	...
	def __init__(self, Scenario, ID=None, Newborn=True):
		...
		# Friend.__init__(self, self.Scenario.None2Default('MaxGurus'), self.Scenario.None2Default('MaxFollowers'))
		Friend.__init__(self, self.Scenario.None2Default('MaxGurus'))
	...
	def observation(self, GroupExaminer):
		...
		GroupExaminer.store('Network',(self.ID,[T.ID for T in Friend.signature(self)]), Numeric=False)
